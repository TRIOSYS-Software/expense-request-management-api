...
func SeedPermissions(db *gorm.DB) error {
	permissions := []models.Permissions{
		...
		{Name: "Expense Request", Entity: "expense-request", Action: "soft-delete", ActionName: "Soft Delete Expense Request"},
		...
		{Name: "Advance Request", Entity: "advance-request", Action: "soft-delete", ActionName: "Soft Delete Advance Request"},
